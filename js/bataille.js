...
function majVueJeu(position,situation){
	...
	var couleur="#FF0000"; //touche rouge  bateau
	if (getCodeCase(position)==-6){couleur="#BBBBFF";}// toucher d leau blue  
	document.getElementById(position).style.backgroundColor=couleur;	
}
function jouerCoup(position){
	nbCoups++;
	var codeCase=getCodeCase(position);// renvoiyer la bonne position
	...
	majVueJeu(position,situation); // mettre a jour
